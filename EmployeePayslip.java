        ...
        switch (desg) {
            ...
            case 2:
                AssistantProfessor ap =
                    new AssistantProfessor(name, id, add, mail, mob, bp);
                ap.getPaySlip();
                ap.disp();
                break;

            case 3:
                AssociateProfessor assp =
                    new AssociateProfessor(name, id, add, mail, mob, bp);
                assp.getPaySlip();
                assp.disp();
                break;
            ...
            case 4:
                Professor pf =
                    new Professor(name, id, add, mail, mob, bp);
                pf.getPaySlip();
                pf.disp();
                break;
